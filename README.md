...
work that is publised in Molecular Biology & Evoution. The repository
has evolved through the project and now contains the processed data and
scripts used to recreate the analyses and figures in the manuscript (as
it is now, for the published manuscript). We have tried our best to
highlight the instances where the code to run an analysis (e.g. for
running BAMM) is not available in this repository.

Any questions about the data or scripts can be directed to me on the
[Issues
tab](https://github.com/padpadpadpad/myxo_diversification/issues) or you
can email me: <d.padfield@exeter.ac.uk>.

## Outputs and references

- Padfield, D., Kay, S., Vos, R., Quince, C., & Vos, M. (2024)
  Macroevolutionary dynamics in micro-organisms: generalists give rise
  to specialists across biomes in the ubiquitous bacterial phylum
  Myxococcota. **Molecular Biology & Evolution**. DOI:
  <https://doi.org/10.1093/molbev/msae088>.
- Raw sequencing data submitted to European Nucleotide Archive:
  <https://www.ebi.ac.uk/ena/browser/view/PRJEB73761>.
- Archived version of this repository after acceptance:
  <https://zenodo.org/doi/10.5281/zenodo.11210843>
...
easy to read in. Raw sequencing can be found on the European Nucleotide
Archive.
