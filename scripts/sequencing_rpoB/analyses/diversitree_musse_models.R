...
# read in best markov model
best_model <- readRDS('data/sequencing_rpoB/processed/transition_rates/mod_custom_6_otu95.rds')
...
# these are taken from the 0s in best_model
lik_musse <- constrain(lik_musse, 
                       q13~0, q14~0, q34~0, q35~0, q41~0, q42~0, q53~0,q54~0)
...
# save out MuSSE models and mcmc
saveRDS(fit_musse, 'data/sequencing_rpoB/processed/transition_rates/otu95_musse.rds')
saveRDS(fit_musse_no_se, 'data/sequencing_rpoB/processed/transition_rates/otu95_musse_no_se.rds')
saveRDS(fit_musse_no_sse, 'data/sequencing_rpoB/processed/transition_rates/otu95_musse_no_sse.rds')
saveRDS(fit_musse_no_ss, 'data/sequencing_rpoB/processed/transition_rates/otu95_musse_no_ss.rds')
...
# read in best markov model
best_model <- readRDS('data/sequencing_rpoB/processed/transition_rates/mod_custom_3_otu97.7.rds')
...
# these are taken from the 0s in best_model
lik_musse <- constrain(lik_musse, 
                       q14~0, q24~0, q25~0, q35~0, q41~0, q45~0, q52~0, q53~0)
...
# save out MuSSE models and mcmc
saveRDS(fit_musse, 'data/sequencing_rpoB/processed/transition_rates/otu97.7_musse.rds')
saveRDS(fit_musse_no_se, 'data/sequencing_rpoB/processed/transition_rates/otu97.7_musse_no_se.rds')
saveRDS(fit_musse_no_sse, 'data/sequencing_rpoB/processed/transition_rates/otu97.7_musse_no_sse.rds')
saveRDS(fit_musse_no_ss, 'data/sequencing_rpoB/processed/transition_rates/otu97.7_musse_no_ss.rds')
