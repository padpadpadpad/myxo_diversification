...
library(curl)
librarian::shelf(diversitree, secsse, DDD, doParallel, foreach, doMC, tidyverse, here, furrr, flextable, patchwork)
...
# save this out
if(transitions == 'all'){saveRDS(inits_ml, paste('data/sequencing_rpoB/processed/secsse/init_vals_ml/otu_cutoffs/', name, 'alltransitions.rds', sep = ''))}
if(transitions == 'hidden'){saveRDS(inits_ml, paste('data/sequencing_rpoB/processed/secsse/init_vals_ml/otu_cutoffs/', name, '.rds', sep = ''))}
