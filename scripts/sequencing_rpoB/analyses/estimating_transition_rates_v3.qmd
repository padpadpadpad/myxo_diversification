...
diversitree_df <- get_diversitree_df(mod_custom8, coding$hab_pref_num2, coding$hab_pref)
...
simmap_best <- readRDS(here("data/sequencing_rpoB/processed/transition_rates/simmap_diversitree.rds"))
...
We can then plot the best model as a network.
