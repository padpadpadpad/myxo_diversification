...
saveRDS(hab_pref, here("sequencing_rpoB/data/processed/hab_pref_vec.rds"))
...
# save out files
saveRDS(ancestral_states_ape, here('sequencing_rpoB/data/processed/ancestral_states/ancestral_states_ape.rds'))
saveRDS(ancestral_states_ape1, here('sequencing_rpoB/data/processed/ancestral_states/ancestral_states_ape1.rds'))
saveRDS(ancestral_states_ape2, here('sequencing_rpoB/data/processed/ancestral_states/ancestral_states_ape2.rds'))
```
...
# read in files
ancestral_states_ape <- readRDS(here('sequencing_rpoB/data/processed/ancestral_states/ancestral_states_ape.rds'))
ancestral_states_ape1 <- readRDS(here('sequencing_rpoB/data/processed/ancestral_states/ancestral_states_ape1.rds'))
ancestral_states_ape2 <- readRDS(here('sequencing_rpoB/data/processed/ancestral_states/ancestral_states_ape2.rds'))
```
