...
# read in bootstrapped tree from treepl
tree <- read.tree('data/sequencing_rpoB/raxml/trees/myxo_asv/bootstraps/raxml_2_treepl_cv.tre')
...
# make custom matrix model
lik_custom1 <- constrain(lik_ard, 
                         q12~0, q14~0, q24~0, q25~0, q41~0, q42~0, q45~0, q53~0, q54~0)
...
# save out best model
saveRDS(mod_custom2, 'data/sequencing_rpoB/processed/transition_rates/mod_custom_2_asvboot2.rds')
...
ggsave('plots/manuscript_plots/transitions_asv_boot2.png', height = 6.5, width = 8.5)
