...
ggsave(here('plots/sequencing_rpoB/analyses/bamm_tree.png'), tree_plot, height = 9, width = 12)
```
...
# make plot
image_ggplot(tree_plot2) + legend + plot_rateshifts + p_rtt + p_tiprates + plot_layout(design = layout, heights = c(0.8, 0.2))

ggsave(here('plots/manuscript_plots/Figure_3.png'), last_plot(), width = 12, height = 12)
