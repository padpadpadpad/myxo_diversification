...
to_constrain <- c(18) # parameters to be a function of others q5a1a and q5b1b
init_factor <- NULL
...
initparsopt <- c(rep(init_lambda, times = 5),
                 rep(init_mu, times = 1),
                 init_transition)
...
saveRDS(mod_secsse, '~/secsse/fit_2hidden_traitandhidden_simplex.rds')