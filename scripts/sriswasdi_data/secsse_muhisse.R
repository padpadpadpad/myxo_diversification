...
library(curl)
librarian::shelf(diversitree, rsetienne/secsse, DDD, apTreeshape, doParallel, phytools, foreach, doMC, tidyverse, here, furrr)
...
fit_secsse <- function(list_inits_sampfrac){
  ...
  saveRDS(output, paste('~/sriswasdi/seccse_', temp_name, sep =''))
