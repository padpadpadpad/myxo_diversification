...
- `sequencing_rpoB` contains the scripts used to analyse the rpoB data.
    - The scripts in `processing` and `tree_building` can be run, then followed by the scripts in `analysis`.
        ...
        - The order of the analysis scripts is as follows:
            ...
            6. **fit_secsse_*_start_vals** finds the maximum likelihood of potential start values for the musse, muhisse, ctd2, ctd3, and ctd4 models fit using secsse.
            7. **fit_secsse_*_v2.R** fits the musse, muhisse, ctd2, ctd3, and ctd4 models using secsse.
            8. **seccse_model_compare.R** compares the musse, muhisse, ctd2, ctd3, and ctd4 models fit with secsse. Recreates **Table 2** and **Table S3**.
