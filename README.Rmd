...
- [x] Samples 16S sequenced **(May 2021)**
  ...
  - [ ] Clustering analysis to look at habitat separation and potential definitions
...
- `scripts` includes the scripts from each part of the project so far. `sequencing_16s` contains the scripts for the 16s sequencing etc.
